...
# Train Random Forest Regressors for each stock
regressors = {}
for stock in stocks:
...
# Define the objective function for Random Forest Regressor optimization
def rf_objective(weights):
...
# Perform Random Forest Regressor optimization
result = minimize(rf_objective, initial_weights, method='SLSQP', bounds=bounds, constraints={'type': 'eq', 'fun': constraint})
